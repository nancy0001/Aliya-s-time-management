...
} else if (isNavalGoals) {
  document.title = "目标管理 - Aliya Time Manager";
} else {
  document.title = "时间管理 - Aliya Time Manager";
}

ReactDOM.createRoot(document.getElementById("root")!).render(
  <React.StrictMode>
    {isSlimMode ? <SlimSupervisorApp /> : isNavalGoals ? <NavalGoalsApp /> : isTimeManager ? <TimeManagerApp /> : <TimeManagerApp />}
  </React.StrictMode>
);
